...
def analysis_sequence(mother_signal_confidence, infant_signal_confidence, window_size = 5, step_size = 0.1, min_seg_length = 30, max_lag = 0.5, fps = 25, interp_peak_ratio = 0.5):

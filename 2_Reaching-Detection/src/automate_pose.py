...
# run with cd 2_Reaching-Detecton\\src
...
if __name__ == '__main__':
    ...
    save_path = os.path.join(PATH, 'pose_detect_output\\') # 'D:\\BRAINRISE_PCI\\face_detect_output'
    ...
    for sub_path in os.listdir(PATH):
        if sub_path.endswith('.mp4'):
            ...
            if not os.path.isdir(new_save_path):
                ...
                command = 'python '+model_path+' '+'--input '+p_vid+' '+'--output '+save_path

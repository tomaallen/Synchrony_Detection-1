...
addpath 'X:\LEAP_PCI\Singapore_PCI\Pose_RQA\BRAINRISE_PCI\Matlab Input' %path for data
current_filepath = 'X:\LEAP_PCI\Singapore_PCI\Pose_RQA\BRAINRISE_PCI\Matlab Input\timepoint3_late_addition\'; %change timepoint as neeeded
...
for i = 1:length(filenames_list)
    ...
    current_filename = strcat(current_filepath, filenames_list{i});
...
addpath 'W:\LEAP_PCI\Singapore_PCI\Pose_RQA\MdRQA-master\MdRQA-master' % path to the actual mdRQA code
